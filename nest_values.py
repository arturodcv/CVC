...
ratio_inh_exc_w = 4.0
p_center_inh_exc = 0.5 ;        weight_inh_exc = - ratio_inh_exc_w * 0.1
p_center_inh_inh = 0.5 ;        weight_inh_inh = - ratio_inh_exc_w * 0.1
p_center_exc_exc = 0.5 ;        weight_exc_exc =  0.4
p_center_exc_inh = 0.5 ;        weight_exc_inh =  0.3
