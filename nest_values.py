...
collect_data_folder = 'results_collect_data_24'
...
kappa_j = 0.126 * 1
kappa_w = 0.14 * 1
weight_large_range_exc_exc = 0.02
weight_large_range_exc_inh = 0.5
...
p_center_exc_exc = 1.0 ;        weight_exc_exc =  0.05
p_center_exc_inh = 1.0 ;        weight_exc_inh =  0.05
